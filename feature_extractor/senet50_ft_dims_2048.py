...
# author: https://github.com/ox-vgg/vgg_face2
class Senet50_ft(nn.Module):
    ...
    @staticmethod
    def identity_dist(id1: torch.Tensor, id2: torch.Tensor):
        return torch.sum(id1 ** 2) + torch.sum(id2 ** 2) - 2 * torch.dot(id1, id2)


def senet50_ft(weights_path=None, **kwargs) -> Senet50_ft:
    """
