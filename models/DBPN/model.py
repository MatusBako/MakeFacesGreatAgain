...
class Net(nn.Module):
    def __init__(self, scale_factor, num_channels=3, base_channels=64, feat_channels=256):
        ...
        self.feat0 = ConvBlock(num_channels, feat_channels, activation='prelu', norm=None)
        self.feat1 = ConvBlock(feat_channels, base_channels, kernel_size=1, stride=1, padding=0,
